...
window.onload = function(){
	...
	function branches()
	{
		...
		for(var i = 0; i < start_points.length; i++)
		{
			...
			drawnLines.push({start_X1:sp.x, start_Y1:H-sp.y, end_X1:ep1.x, end_Y1:H-ep1.y, start_X2:sp.x, start_Y2:H-sp.y, end_X2:ep2.x, end_Y2:H-ep2.y, draw_width:line_width+2})
...
function remove_lines(number){
var barrier=drawnLines.length-1
var barrier2=drawnLines.length/2-1

for (var n = barrier; n >=barrier2 ; n--) {
	ctx.beginPath();
...
$(document).ready(function() {
  ...
  else if(age!=100 && age%10==0 && previousAge>age){
   	previousAge=age
